...
def draw_Rectangles(draw, width, height):
    ...
    draw.rectangle( [0, 0, 1280, height/3], "#FF9933") #Colour code, Deep Saffron - #FF9933
    draw.rectangle( [0, height/3, 1280, 2 * height/3], "white")
    draw.rectangle( [0, 2 * height/3, 1280, height], "#138808") #Colour code, India green - #138808
    return
